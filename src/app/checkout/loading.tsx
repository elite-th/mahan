export default function CheckoutLoading() {
  return (
    <div className="container mx-auto px-4 py-12 animate-pulse">
      <div className="h-10 w-48 bg-slate-700/50 rounded-xl mb-8" />
        ...
        <div className="bg-slate-800/40 rounded-xl border border-slate-700/50 p-6 space-y-4">
          ...
          {Array.from({ length: 5 }).map((_, i) => (
            <div key={i} className="space-y-2">
              ...
              <div className="h-11 w-full bg-slate-700/30 rounded-xl" />
            </div>
          ))}
          <div className="h-12 w-full bg-sky-600/30 rounded-xl mt-4" />
        </div>
        ...
        <div className="bg-slate-800/40 rounded-xl border border-slate-700/50 p-6 space-y-4 h-fit">
          ...
          {Array.from({ length: 3 }).map((_, i) => (
            <div key={i} className="flex gap-3">
              <div className="w-16 h-16 bg-slate-700/40 rounded-lg shrink-0" />
