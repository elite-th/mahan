...
const SOLUTIONS: SolutionData[] = [
  ...
  },
  {
    ...
    details:
      "در صورت نیاز به دریافت خدمات راه‌اندازی میل سرور می‌توانید با شماره تلفن 0219104448 با شرکت ویرا شبکه آران تماس حاصل فرمایید. مایکروسافت Exchange Server برای دسترسی کاربران به پلتفرم پیام‌رسانی از طریق دستگاه‌های تلفن همراه، رایانه‌های رومیزی و سیستم‌های مبتنی بر وب طراحی شده است.",
    color: {
