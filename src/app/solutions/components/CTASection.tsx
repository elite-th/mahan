...
const COLOR_CSS_MAP: Record<string, { from: string; border: string }> = {
  ...
  'bg-[var(--accent-hover)]/10': { from: 'rgba(14, 165, 233, 0.15)', border: 'rgba(14, 165, 233, 0.2)' },
...
export default function CTASection({ color }: CTASectionProps) {
  ...
  return (
    ...
    >
      <div className="bg-[var(--surface-1)] rounded-xl p-6 md:p-8">
        <div className="flex flex-col md:flex-row items-center gap-4 md:gap-6">
          {/* Text content */}
          <div className="flex-1 text-center md:text-right">
            <h4 className="text-[var(--text)] font-bold text-xl mb-1">
