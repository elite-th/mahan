...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: '/og-image.jpg', width: 1344, height: 768, alt: `${COMPANY_SLOGAN} - تجهیزات شبکه و راهکارهای فناوری اطلاعات` }],
  },
  twitter: {
  ...
  icons: {
    icon: [{ url: '/favicon.gif' }, { url: '/favicon.gif', sizes: 'any' }],
    apple: '/favicon.gif',
  },
