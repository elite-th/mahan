...
const OurClientsSection: React.FC = () => {
  return (
    <section
      id="clients"
      className="border-b border-[#383150] bg-[#1a1625] py-20 sm:py-24"
    ...
    >
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-12 max-w-2xl">
          <h2
            id="clients-heading"
            className="text-3xl font-semibold leading-tight text-[#f4f1fb] sm:text-4xl"
          >
            همکاران تجاری ما
          </h2>
          <p className="mt-4 text-base leading-8 text-[#c5bede]">
            افتخار همکاری با مجموعه‌ای از سازمان‌ها و شرکت‌ها در صنایع مختلف.
          </p>
        </div>

        <ul
          className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-px bg-[#383150] border border-[#383150] rounded-lg overflow-hidden"
          role="list"
          aria-label={`همکاران تجاری ${COMPANY_SLOGAN}`}
        >
          {MOCK_CLIENTS.map((client) => (
            <li key={client.id} className="bg-[#1a1625]">
