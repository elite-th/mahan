...
/**
 * OurClientsSection — static grid (catalog mode).
 *
 * Shows all clients in a responsive grid (2 cols mobile, 3 tablet, 4
 * desktop). No marquee/carousel animation. Each card is display-only (no
 * links). Clients with a logo show the image; those without show a text
 * monogram (handled by ClientLogoCard).
 */
