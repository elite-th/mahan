...
const FaqItem: React.FC<{
    ...
    return (
        <div className="border-b border-[#383150]">
            <button
                onClick={onClick}
            ...
            >
                <span className="text-sm sm:text-base font-medium text-[#f4f1fb] leading-relaxed flex-1">
                    {item.question}
                </span>
                <span className="shrink-0 text-[#c5bede]" aria-hidden="true">
            ...
            >
                <div className="overflow-hidden">
                    <p className="pb-4 text-sm text-[#c5bede] leading-7">
                        {item.answer}
                    </p>
                </div>
            </div>
...
const FaqSection: React.FC = () => {
    ...
    return (
        <section id="faq" className="border-b border-[#383150] bg-[#1a1625] py-20 sm:py-24">
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid lg:grid-cols-12 gap-10 lg:gap-12">
                    ...
                    <aside className="lg:col-span-4 lg:sticky lg:top-24 lg:self-start">
                        ...
                        <p className="mt-4 text-sm text-[#c5bede] leading-7 max-w-md">
                    ...
                    <div className="lg:col-span-8 border-t border-[#383150]">
